...
![Description](./images/inside_file_docx.png)
...
![Cấu trúc thư mục](./images/inside_file_zip.png)
...
Kể từ Step 21, người biên soạn bắt đầu thay thế dần các ký tự của flag nhằm biến nó thành câu hỏi vô hại `Did you see the flag?` để che giấu flag thực tế.
